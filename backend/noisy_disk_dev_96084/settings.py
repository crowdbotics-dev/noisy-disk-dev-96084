"""
Django settings for noisy_disk_dev_96084 project.
...
ROOT_URLCONF = 'noisy_disk_dev_96084.urls'
...
WSGI_APPLICATION = 'noisy_disk_dev_96084.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_disk_dev_96084 API",
    "DESCRIPTION": "API documentation for noisy_disk_dev_96084 App",
    "VERSION": "v1",
}
